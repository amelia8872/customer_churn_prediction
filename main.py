...
# Iterate through each row and generate a string:CustomerId - Surname
customers = [
...
if selected_customer_option:
  ...
  print("Slected Customer", selected_customer)
  ...
  with col2:
    balance = st.number_input("Balance",
                              min_value=0.0,
                              max_value=float(selected_customer['Balance']))
  ...
  st.subheader("Perosnalized Email")
